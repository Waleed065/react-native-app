...
import {singleOrderSchema} from '../../types';
...
const OrderItSelf = ({
  ...
  const {displayName, time, email, shouldMark} = item;
  ...
  const onDelete = () => {
    ...
    onPrimaryDelete({
      collection: !isInTrash ? 'orders' : 'trash',
      id,
      item,
